...
$arParams['PATH_TO_CONTACT_SHOW'] = '/realty/clients/clientinfo/';
$arParams['PATH_TO_CONTACT_EDIT'] = CrmCheckPath('PATH_TO_CONTACT_EDIT', $arParams['PATH_TO_CONTACT_EDIT'], $APPLICATION->GetCurPage().'?contact_id=#contact_id#');
...
// dump($arParams['PATH_TO_CONTACT_SHOW']);
...
foreach($arResult['CONTACT'] as &$arContact)
{
	...
	{
		$arContact['PATH_TO_CONTACT_SHOW'] = $arParams['PATH_TO_CONTACT_SHOW'].'?id='.$arContact['ID'];
		$arContact['PATH_TO_CONTACT_EDIT'] = CCrmUrlUtil::AddUrlParams($arContact['PATH_TO_CONTACT_DETAILS'],false);
	}
	else
	{
